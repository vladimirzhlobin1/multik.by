...
';
 ...
 echo '
 <h2 class="itog-price"style="text-align:right>Итого: <strong>'.group_numerals($all_price).'</strong> руб</h2>
...
{
    echo '<h3 id="clear-cart" style="text-align:center>Корзина пуста</h3>';
}
...
<li><label for="order_phone"><span>*</span>Телефон</label><input type="text" name="order_phone" id="order_phone" value="'.$_SESSION["order_phone"].'" /><span class="order_span_style" >Пример: 8 033 650 15 </span></li>
<li><label class="order_label_style" for="order_address"><span>*</span>Адрес<br /> доставки</label><input type="text" name="order_address" id="order_address" value="'.$_SESSION["order_address"].'" /><span>Пример: г. Жлобин,<br /> ул Московская д 33</span></li>
';
}
echo '
...
<p </div> <input type="submit" name="submitdata" id="confirm-button-next" value="Далее" /></p>
</form>
...
';    
 ...
 echo '
<h2 class="itog-price" style="text-align:right>Итого: <strong>'.$itogpricecart.'</strong> руб</h2>
  <p style="text-align:right class="button-next" ><a href="" >Оплатить</a></p> 
...
';
 ...
 echo '
 <h2 class="itog-price" >Итого: <strong>'.group_numerals($all_price).'</strong> руб</h2>
 <p  class="button-next" ><a href="cart.php?action=confirm" >Далее</a></p> 
 ';
