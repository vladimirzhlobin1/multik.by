...
<title>Интернет-магазин-игрушек-в-городе-Жлобине</title>
</head>
...
<?php
//.....................................................................................................
$num = 14; // Здесь указываем сколько хотим выводить товаров.
    $page = (int)$_GET['page'];              
...
do
{
if  ($row["image"] != "" && file_exists("./uploads_images/waterpool/".$row["image"]))
{
$img_path = './uploads_images/waterpool/'.$row["image"];
$max_width = 200; 
$max_height = 200; 
...
{
$img_path = "/images/noimages80x70.png.png";
$width = 80;
$height = 70;
} 	
