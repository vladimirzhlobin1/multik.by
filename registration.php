...
rules:{
	...
	submitHandler: function(form){
        ...
        //form.preventDefault(); // прерываем отправку формы
        ...
        $.ajax({
            ...
            success: function(html){
                ...
                $(".reg").fadeOut(300);
                $(".regmsg").addClass("reg_mess_good").fadeIn(400).html("Вы успешно зарегистрированы!");
...
<p class="regmsg"></p>
<div id="block-content" class="reg">
...
<p style="text-align:right;"><input type="submit" name="reg_submit" id="form_submit" value="Регистрация" /></p>
